...
type FileTime = any
type AskAccept = any
type AskUserSurvey = any
type Function = any
type LevelUpItemInfo = any
type Random = any
type AskCustomMixHair = any
...
type AskYesNo = any
type SayIllustration = any
type AskAngelicBuster = any
type Date = any
type AskAvatarEx = any
type AskMixHair = any
type AskNumberKeypad = any
type AskSpeedQuiz = any
type AskPetAll = any
type AskQuiz = any
type AskAndroid = any
type AskBoxText = any
type AskPet = any
type AskSelectMenu = any
type ItemSpecialExData = any
type AskActionPetEvolution = any
type AskMixHairNew = any
type AskNumber = any
...
declare interface ScriptField {
	...
	setMapTaggedObjectSmoothVisible(tag: String, visible: boolean, nManual: int, tDelay: int): void
	...
	showMillisecondTimer(seconds: int): void
	...
	setJinHillBossId(var1: int): void

	setLucidBossId(var1: int): void

	setDuskBossId(var1: int): void

	resetHourglass(time: int, skill: int, level: int): void

	blowWeatherEffectNotice(var1: String, var2: int, var3: int): void

	startFieldEvent(): void

	startDemianFieldEvent(stage: int, demianId: int): void
...
declare interface ScriptNpc extends PlayerScriptInteraction {
	...
	SayNext(msg: String): Say

	SayImage(message: String): SayImage

	AskAccept(message: String): AskAccept

	AskActionPetEvolution(message: String): AskActionPetEvolution

	AskAndroid(message: String): AskAndroid

	AskAngelicBuster(): AskAngelicBuster

	AskAvatarEx(message: String): AskAvatarEx

	AskBoxText(message: String, msg2: String, col: int, line: int): AskBoxText

	AskCustomMixHair(message: String): AskCustomMixHair

	AskMenu(message: String): AskMenu

	AskMenuA(message: String): AskMenu

	AskMixHair(message: String): AskMixHair

	AskMixHairNew(message: String): AskMixHairNew

	AskNumber(msg: String, def: int, min: int, max: int): AskNumber

	AskNumberKeypad(message: String): AskNumberKeypad

	AskPet(message: String): AskPet

	AskPetAll(message: String): AskPetAll

	AskSelectMenu(value: int, arr: String[]): AskSelectMenu

	AskText(msg: String, defText: String, nLenMin: short, nLenMax: short): AskText

	AskAntiMacroText(msg: String, defText: String, nLenMin: short, nLenMax: short, imageData: byte[]): AskText

	AskUserSurvey(message: String): AskUserSurvey

	AskYesNo(message: String): AskYesNo

	SayIllustration(message: String, delay: int, index: int, left: boolean): SayIllustration

	AskQuiz(): AskQuiz

	AskSpeedQuiz(): AskSpeedQuiz
	...
	askCustomMixHair(message: String, angelicBuster: boolean, zeroBeta: boolean): [baseColor: number, mixColor: number, mixProb: number]
	...
	setCameraReturnToUser(var1: byte, var2: int): void

	setCameraFreeFromUser(): void

	setCameraScaleAbsMove(var1: byte, var2: int, var3: int, var4: int, var5: int, var6: int): void

	setCameraRelMove(var1: byte, var2: int, var3: int, var4: int): void

	setCameraAbsMove(var1: byte, var2: int, var3: int, var4: int): void

	setCameraScale(var1: byte, var2: int, var3: int, var4: int): void

	setCameraPutlooseLevel(var1: int): void

	setCameraScaleRelMove(var1: byte, var2: int, var3: int, var4: int, var5: int, var6: int): void

	setCameraStickToUser(): void
...
declare interface ScriptPlayer extends AbstractScriptBinding {
	...
	setMixAddHairColor(var1: byte): void

	setMixBaseHairColor(var1: byte): void

	setMixHairBaseProb(var1: byte): void

	setSubHair(var1: int): void

	setSubFace(var1: int): void

	setSubSkin(var1: byte): void
	...
	fieldEffect40(s1: String, link: String, b1: boolean, n1: int, n2: int, n3: int, n4: int, b2: boolean, b3: boolean, s2: String, b4: boolean, n5: int, b5: boolean, s3: String, b6: boolean, n6: int): void
...
declare interface FamiliarInfo {
	getOption(type: int): int

	setOption(i: int, option: int): void
